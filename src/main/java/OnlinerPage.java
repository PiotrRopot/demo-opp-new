public class OnlinerPage {
    ...
    public static final String TXT_COPYRIGHT = "© 2001—2023 Onlíner";
    public static final String TXT_OPEN = "Вход";

    public static final String BTN_OPEN = "//div[@class=\"auth-bar__item auth-bar__item--text\"]";
